...
- Crie um projeto angular com ng: `ng new portifolio.client --defaults --skip-install --skip-git --no-standalone `.
...
- Criar o arquivo de projeto (`portifolio.client.esproj`).
